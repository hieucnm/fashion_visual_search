...
class ClassBalancedBatchSampler(object):
    ...
    def sample_batch(self):
        ...
        # modified by HieuCNM - 09/06/2020 : dict_keys cannot be cast directly to list in Python 3
        # sampled_classes = np.random.choice(self.reverse_index.keys(), num_classes, replace=False)
