...
def train(args):
    ...
    for epoch in range(args.epochs):
        ...
        save_checkpoint(model.state_dict(), is_best, fpath=osp.join(args.log_dir, 'last_checkpoint_item.pth'))
...
#     parser.add_argument('--train-path', type=str, default=osp.join(PREPROCESS_LOG_DIR, 'splits/train_valid_item/train.csv'))
#     parser.add_argument('--valid-path', type=str, default=osp.join(PREPROCESS_LOG_DIR, 'splits/train_valid_item/valid.csv'))
#     parser.add_argument('--test-path' , type=str, default=osp.join(PREPROCESS_LOG_DIR, 'splits/train_valid_item/valid.csv'))
#     parser.add_argument('--class-path', type=str, default= osp.join(PREPROCESS_LOG_DIR, 'mappers/item_mapper.json'))
    
    FINAL_ANNO_DIR = osp.join(__cwd__, 'datasets/deepfashion/inshop/Anno/final/item')
    parser.add_argument('--train-path', type=str, default=osp.join(FINAL_ANNO_DIR, 'train.csv'))
    parser.add_argument('--valid-path', type=str, default=osp.join(FINAL_ANNO_DIR, 'valid.csv'))
    parser.add_argument('--test-path' , type=str, default='')
    parser.add_argument('--class-path', type=str, default= osp.join(FINAL_ANNO_DIR,'item_mapper.json'))
                        
    parser.add_argument('--log-dir', type=str, default=LOG_DIR)                    
    parser.add_argument('--model-path', type=str, default=osp.join(__cwd__, ''))
